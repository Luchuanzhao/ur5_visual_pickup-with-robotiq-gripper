# ur5-pickup
ur5 visual capture with robotiq-85 gripper instead of vaccum gripper!
You should download the description file for **ur5** and **Robotiq-85 gripper** and then you can launch `initialize_gripper.launch` to start gazebo.
